    ...
    return (
        ...
        <div className={cx('body')}>
            <div className={cx('main')}>
                <div className={cx('container', 'a-container')} id="a-container">
                    <form className={cx('form')} id="a-form" method="" action="">
                        ...
                        <div className={cx('form__icons')}>
                            ...
                            <FontAwesomeIcon className={cx('form__icon')} icon={faFacebookF} />
                            <FontAwesomeIcon className={cx('form__icon')} icon={faGoogle} />
                            <FontAwesomeIcon className={cx('form__icon')} icon={faTwitter} />
                        </div>
                        <span className={cx('form__span')}>or use email for registration</span>
                        <input
                        ...
                        {isInvalidPassword && (
                            <div className={cx('form-messager-wrapper')}>
                                <div className={cx('form-message')}>Password must have:</div>
                        ...
                        <div
                            className={cx('form__button', 'button', 'submit')}
                ...
                <div className={cx('switch')} id="switch-cnt">
                    <div className={cx('switch__circle')}></div>
                    <div className={cx('switch__circle', 'switch__circle--t')}></div>
                    <div className={cx('switch__container')} id="switch-c1">
                        <h2 className={cx('switch__title', 'title')}>Welcome Back !</h2>
                        <p className={cx('switch__description', 'description')}>
                            To keep connected with us please login with your personal info
                        </p>
                        <Link to="/signin">
                            <div className={cx('switch__button', 'button', 'switch-btn')}>
                                SIGN IN
                            </div>
                        </Link>
                    </div>
